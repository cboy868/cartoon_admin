  ...
  <Layout style="height: 100%" class="main">
    ...
    <Layout>
      <Sider
        ...
        v-model="collapsed"
        class="left-sider"
        :style="{overflow: 'hidden',background:'url('+leftBackground+') repeat-y 0 0'}"
      >
        <side-menu
          accordion
          ref="sideMenu"
...
import SideMenu from "./components/side-menu-new";
import TagsNav from "./components/tags-nav";
import User from "./components/user";
import ABackTop from "./components/a-back-top";
import Fullscreen from "./components/fullscreen-new";
